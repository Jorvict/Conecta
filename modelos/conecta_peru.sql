...
CREATE TABLE `distritos`  (
  ...
  CONSTRAINT `distritos_fk1` FOREIGN KEY (`IdProvincia`) REFERENCES `provincia` (`IdProvincia`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 250402 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
